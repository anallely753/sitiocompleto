...
<main class="container main-crear-curso text-md-center">
	...
	<div class="mt-md-4 mt-4">
		<form class="mx-md-auto" action="{{route('admintareas.update', $tarea->id)}}" enctype="multipart/form-data" method="POST">
			@method('PATCH')
			@csrf
			...
			@else
			<label for="file" class="d-block text-left">Subir archivo</label>
			<input type="file" name="file" enctype>
			@endif
