...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="body-welcome p-3 center">
        ...
        <form class="container d-flex mt-3 mt-md-3" action="{{route('register')}}" method="POST">
            @csrf
           <!-- Name -->
           ...
           <a href="{{route('login')}}" class="text-right text-purple form-label-link mt-2">¿Ya tienes cuenta? Inicia sesión</a>
